...
const Display2=()=>{
        ...
        const upScale =()=>{setScale(scale+10)}
        const downScale =()=>{setScale(scale-10)}
        const handlers ={upScale,downScale}
    ...
    return reason });
        ...
        return(
            ...
            <div>                                }*/} 
            <div /*onScroll={{scale:"2"}}*/ style={{/*maxWidth:`${scale}%` *//*maxHeight:`${scale}%`,*//*width:`${scale}%` , height:"auto"*/}}> 

                        ...
                        <Table >
                            <TableHead>
                                ...
                                <TableRow  >
                                    ...
                                    <TableCell style={{backgroundColor:"lightblue"}} align ="center">Device Name</TableCell>
                                    <TableCell  style={{backgroundColor:"red"}} align="center">RT Pair</TableCell>
                                    
                                    <TableCell  style={{backgroundColor:"yellow"}} align="center">VRF Local ID</TableCell>
                                    <TableCell  style={{backgroundColor:"orange"}} align="center">Instance Name</TableCell>
                                    <TableCell  style={{backgroundColor:"indigo"}} align="center">UUID</TableCell>
                                ...
                                {selectedDevices && selectedDevices.map((disData)=>{
                                    return (
                                        ...
                                        {//onClick={(id)=>clickMe(disData.UUID)}
                                            ...
                                            <TableRow  >
                                                <TableCell align ="center" >{disData.name}</TableCell>
                                                <TableCell align ="center" >{disData.rt_pair}</TableCell>
                                                <TableCell align ="center" >{disData.vrf_local_id}</TableCell>

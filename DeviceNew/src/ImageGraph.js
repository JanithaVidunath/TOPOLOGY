...
var nodes = new vis.DataSet();
    nodes.add([
		{ id: 1, label: "Router 1",x:0,y:0, title:htmlTitle("Go wild <span style='display': inline-block; animation: be-tacky 5s ease-in-out alternate infinite; margin: 5px;'>!</span>"), shape:"image",image:"WhatsApp Image 2022-03-23 at 13.25.21.jpeg",shadow: true ,color:{hover:"red"}},
